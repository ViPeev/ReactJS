...
export default function User(props) {
  ...
  const { setInfoView, setEditView, setDeleteView } = useContext(ViewContext);
  ...
  return (
    <tr>
      <td>
        <img
          src={props.imageUrl}
          alt={`${props.firstName}'s profile picture`}
          className="image"
        />
      </td>
      ...
      <td className="actions">
        ...
        <button className="btn info-btn" title="Info" onClick={infoHandler}>
          <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fas"
