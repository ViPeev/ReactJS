...
import { formatData } from "../../utils.js/dataParser";
import validate from "../../utils.js/formValidate";

export default function AddUser({ closeForm }) {
  ...
  const notValid = Object.values(data).some((x) => !x);
  ...
  const submitHandler = async (e) => {
    ...
    const user = await createOrUpdate("create", formatData(data));
      ...
      <div className="modal">
        <div className="user-container">
          <header className="headers">
            ...
            <button
              className="btn close"
              onClick={closeForm.bind(null, "create")}
            >
              <svg
                aria-hidden="true"
                focusable="false"
